                      ...
                      <div class="row contactv2 text-center">
                          <div class="col-md-4">
                              <div class="small-box">
                                  ...
                                  <small>Phone:+6281382779696</small>
                                  <p><a href="mail:to">tuladhaapp@gmail.com</a></p>
                              </div><!-- end small-box -->
                          </div><!-- end col -->
                          ...
                          <div class="col-md-4">
                              <div class="small-box">
                                  ...
                                  <small>Jalan Gayung Kebonsari Timur No. B30</small>
                                  <small>Kecamatan Gayungan, Surabaya</small>
                              </div><!-- end small-box -->
                          </div><!-- end col -->
                          ...
                          <div class="col-md-4">
                              <div class="small-box">
                                  ...
                                  <h4>Be Social</h4>
                                  <small>Twitter: @tuladhaapp</small>
                                  <small>Facebook: facebook.com/tuladhaapp</small>
                                  <p><a href="mail:to">Email Newsletter</a></p>
                              </div><!-- end small-box -->
                          </div><!-- end col -->
                      </div><!-- end contactv2 -->
