                ...
                <nav class="navbar navbar-default yamm">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li class="dropdown yamm-fw yamm-half"><a  data-toggle="dropdown" class="dropdown-toggle active">Courses<b class="fa fa-angle-down"></b></a>
        ...
        <section class="section gb">
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <p>Lessons that you might like</p>
                </div><!-- end title -->
                ...
                <div id="owl-01" class="owl-carousel owl-theme owl-theme-01">
                    ...
                    <div class="caro-item">
                        <div class="course-box">
                            <div class="image-wrap entry">
                                <img src="upload/chemistry.jpg" alt="" class="img-responsive">
                                <div class="magnifier">
                                     <i class="flaticon-add"></i>
                                </div>
                            </div><!-- end image-wrap -->
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="box testimonial">
                            <p class="testiname"><strong><img src="upload/testimonial_01.jpg" alt="" class="img-circle"> Afifah Dian</strong></p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="widget clearfix">
                            ...
                            <li class="readmore">Became a Tutor</li>
                        </div><!-- end widget -->
                    </div><!-- end col -->
