...
<body>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="tagline-message event-title text-center">
                            ...
                            <a href="maintenis.html" class="btn btn-primary">GET TICKETS</a>
                        </div>
                    </div><!-- end col -->
                </div><!-- end row -->
            </div><!-- end container -->
                ...
                <div class="row text-center">
                    <div class="col-md-4 col-sm-6">
                        <div class="teammembers">
                            <div class="entry">
                                <img src="upload/01_team.jpg" alt="" class="img-responsive">
                                <div class="magnifier">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="teammembers">
                            <div class="entry">
                                <img src="upload/02_team.jpg" alt="" class="img-responsive">
                                <div class="magnifier">
                                    <div class="visible-buttons1 teambuttons">
                                        <p>We’re committed to work and play our client meeting room transforms  into a table tennis</p>
                                        <div class="social-links">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="teammembers">
                            <div class="entry">
                                <img src="upload/03_team.jpg" alt="" class="img-responsive">
                                <div class="magnifier">
                                    <div class="visible-buttons1 teambuttons">
                                        <p>We’re committed to work and play our client meeting room transforms  into a table tennis</p>
                                        <div class="social-links">
                            ...
                            <div class="teamdesc">
                                  <h4>Muhadjir Effendi</h4>
                                <p>Menteri Pendidikan Republik Indonesia</p>
                            </div><!-- end teamdesc -->
                        </div><!-- end teammembers -->
                    </div><!-- end col -->
                </div><!-- end row -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-3">
                        <div class="widget clearfix">
                            ...
                            <li class="readmore">Become a Teacher</li>
                        </div><!-- end widget -->
                    </div><!-- end col -->
    ...
    <script src="js quorush/js/parallax.js"></script>
